...
/**
* The F1_house_A11 class implements the F1_house_A11 interaction in the
* GLDTestFederation simulation.
*/
public class F1_house_A11 extends C2WInteractionRoot {

	/**
	* Default constructor -- creates an instance of the F1_house_A11 interaction
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the F1_house_A11 interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the F1_house_A11
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.F1_house_A11"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the F1_house_A11 interaction class.
	*/
	public static String get_simple_class_name() { return "F1_house_A11"; }
	...
	* F1_house_A11 interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.F1_house_A11" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.F1_house_A11", F1_house_A11.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.F1_house_A11", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.F1_house_A11", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.F1_house_A11:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.F1_house_A11" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.F1_house_A11", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.F1_house_A11" );
		_classHandleSimpleNameMap.put( get_handle(), "F1_house_A11" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.F1_house_A11,air_temperature", get_air_temperature_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.F1_house_A11,cooling_setpoint", get_cooling_setpoint_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.F1_house_A11:  could not publish:  ";

	/**
	* Publishes the F1_house_A11 interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.F1_house_A11:  could not unpublish:  ";
	/**
	* Unpublishes the F1_house_A11 interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.F1_house_A11:  could not subscribe:  ";
	/**
	* Subscribes a federate to the F1_house_A11 interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.F1_house_A11:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the F1_house_A11 interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the F1_house_A11 interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the F1_house_A11 interaction class).
	...
	*/
	...
	protected F1_house_A11( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected F1_house_A11( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the F1_house_A11 interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new F1_house_A11 interaction class instance
	*/
	public F1_house_A11( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #F1_house_A11( ReceivedInteraction datamemberMap )}, except this
	* new F1_house_A11 interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new F1_house_A11 interaction class instance
	* @param logicalTime timestamp for this new F1_house_A11 interaction class
	* instance
	*/
	public F1_house_A11( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new F1_house_A11 interaction class instance that is a duplicate
	* of the instance referred to by F1_house_A11_var.
	*
	* @param F1_house_A11_var F1_house_A11 interaction class instance of which
	* this newly created F1_house_A11 interaction class instance will be a
	* duplicate
	*/
	public F1_house_A11( F1_house_A11 F1_house_A11_var ) {
		super( F1_house_A11_var );
		
		
		set_air_temperature( F1_house_A11_var.get_air_temperature() );
		set_cooling_setpoint( F1_house_A11_var.get_cooling_setpoint() );
	}
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		else if ( get_cooling_setpoint_handle() == datamemberHandle ) return new Double( get_cooling_setpoint() );
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		else if ( param_handle == get_cooling_setpoint_handle() ) set_cooling_setpoint( Double.parseDouble( val ) );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof F1_house_A11 ) {
			F1_house_A11 data = (F1_house_A11)object;
