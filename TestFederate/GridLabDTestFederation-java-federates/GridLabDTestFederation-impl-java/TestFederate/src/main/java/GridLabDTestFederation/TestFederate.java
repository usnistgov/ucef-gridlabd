...
public class TestFederate extends TestFederateBase {
    ...
    private void CheckReceivedSubscriptions(String s) {
        ...
        while ((interaction = getNextInteractionNoWait()) != null) {
            if (interaction instanceof Global) {
                handleInteractionClass((Global) interaction);
            }
    ...
    private void execute() throws Exception {
        ...
        while (true) {
            ...
            //
            //    CoolingControl vCoolingControl = create_CoolingControl();
            //    vCoolingControl.set_cooling_setpoint( < YOUR VALUE HERE > );
            //    vCoolingControl.set_name( < YOUR VALUE HERE > );
            //    vCoolingControl.sendInteraction(getLRC(), currentTime);
            //
            //    HeatingControl vHeatingControl = create_HeatingControl();
            //    vHeatingControl.set_heating_setpoint( < YOUR VALUE HERE > );
            //    vHeatingControl.set_name( < YOUR VALUE HERE > );
            //    vHeatingControl.sendInteraction(getLRC(), currentTime);
            //
            ////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void handleInteractionClass(Global interaction) {
        //////////////////////////////////////////////////////////////////////////
