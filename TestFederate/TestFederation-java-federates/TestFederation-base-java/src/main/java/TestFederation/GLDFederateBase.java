...
public class GLDFederateBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public GLDFederateBase(FederateConfig config) throws Exception {
		super(config);
        ...
        GlobalVariables.publish(getLRC());
	...
	public GlobalVariables create_GlobalVariables() {
	   GlobalVariables interaction = new GlobalVariables();
